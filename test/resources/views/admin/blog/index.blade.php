                        ...
                        <div class="modal-content border-0 rounded-4 shadow-lg">
                            ...
                            <div class="modal-body px-4 pb-4">          
                                ...
                                <div class="d-flex justify-content-end gap-1 mt-6">
                                    <button class="bg-yellow-500 hover:bg-yellow-600 text-white px-5 py-2 rounded" data-bs-toggle="modal" data-bs-target="#editBlogModal{{ $blog->id }}">
                                        Edit Blog
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="modal-body px-4 pb-4">
                                <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <a href="{{ route('admin.blogs') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-5 py-3 rounded-lg font-semibold">
                                            Cancel
                                        </a>
                ...
                <div class="modal-body px-4 pb-4">
                    <form action="{{ route('admin.blogs.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <x-text-input id="title" class="form-input" type="text" name="title" :value="old('title')" required autofocus autocomplete="title"/>
                        ...
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-input" required>
                                ...
                                <option value="company_activity" {{ old('type') == 'company_activity' ? 'selected' : '' }}>Company Activity</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="excerpt" name="excerpt" class="form-input" rows="3" required>{{ old('excerpt') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" class="form-input" rows="5" required>{{ old('content') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <x-text-input id="seo_title" class="form-input" type="text" name="seo_title" :value="old('seo_title')" required autofocus autocomplete="seo_title"/>
                        ...
                        <div class="form-group">
                            ...
                            <x-text-input id="seo_description" class="form-input" type="text" name="seo_description" :value="old('seo_description')" required autofocus autocomplete="seo_description"/>
