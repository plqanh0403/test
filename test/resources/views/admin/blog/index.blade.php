...
@section('content')
    <x-admin.page-header title="Blog Management" description="Manage all blogs in the system">

        <x-slot:action>
            <a href="{{ route('admin.categories') }}" class="btn btn-export d-flex align-items-center justify-content-center">
                Category Management
            </a>

            <button class="btn btn-create" data-bs-toggle="modal" data-bs-target="#createBlogModal">
                + Create Blog
            </button>
        </x-slot:action>
    ...
    <div class="blog-tabs">
        ...
        <a href="{{ route('admin.blogs', ['type' => 'tech-service']) }}"
            class="blog-tab {{ $type == 'tech-service' ? 'active' : '' }}">
            <i class="bi bi-cpu-fill"></i>
            Technical Services
            <span>{{ $servicesCount }}</span>
        </a>

        <a href="{{ route('admin.blogs', ['type' => 'EGEAD-activity']) }}"
            class="blog-tab {{ $type == 'EGEAD-activity' ? 'active' : '' }}">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-view" data-bs-toggle="modal"
                            data-bs-target="#detailBlogModal{{ $blog->id }}">
                        ...
                        @else
                            <form action="{{ route('admin.blogs.show', $blog->id) }}" method="POST" class="inline-block">
                                ...
                                <button class="btn btn-unlock px-3 py-1 rounded"
                                    onclick="return confirm('Show this blog?')">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            ...
                                            <span class="badge {{ $blog->is_visible ? 'bg-primary' : 'bg-secondary' }}">
                            ...
                            <div class="modal-body">
                                ...
                                @if ($blog->thumbnail)
                                    <div class="admin-card mb-4">
                                        ...
                                        <img src="{{ Storage::url($blog->thumbnail) }}" class="img-fluid rounded-4 w-100"
                                            tyle="max-height:350px;object-fit:cover;">
                                        ...
                                        <div class="col-lg-8 d-flex">
                                            ...
                                            <div class="admin-card content-card flex-grow-1">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="excerpt" rows="4" class="form-control admin-input" placeholder="Short description..."
                                                        required>{{ $blog->excerpt }}</textarea>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="admin-card mb-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="is_visible" class="form-select">
                                                        <option value="1"
                                                            {{ old('is_visible', $blog->is_visible) == '1' ? 'selected' : '' }}>
                                                            Visible
                                                        </option>

                                                        <option value="0"
                                                            {{ old('is_visible', $blog->is_visible) == '0' ? 'selected' : '' }}>
                                                            Hidden
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="category_id" class="form-select">
                                                        <option value="{{ $blog->category_id }}">
                                                            {{ $blog->category->name ?? '-- Select category --' }}
                                                        </option>
                                                ...
                                                <div>
                                                    ...
                                                    <select name="type" class="form-select">
                                                        ...
                                                        <option value="tech-service"
                                                            {{ old('type', $blog->type) == 'tech-service' ? 'selected' : '' }}>
                                                            Tech Service
                                                        </option>

                                                        <option value="EGEAD-activity"
                                                            {{ old('type', $blog->type) == 'EGEAD-activity' ? 'selected' : '' }}>
                                                            EGEAD Activity
                                                        </option>
                                            ...
                                            <div class="admin-card mb-4">
                                                ...
                                                <input type="text" name="thumbnail_alt"
                                                    value="{{ old('thumbnail_alt', $blog->thumbnail_alt) }}"
                            ...
                            <div class="col-lg-8 d-flex">
                                ...
                                <div class="admin-card content-card flex-grow-1">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" required name="title" class="form-control admin-input"
