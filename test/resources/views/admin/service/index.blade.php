            ...
            @foreach ($services as $service)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($service->is_visible)
                            <form action="{{ route('admin.services.hide', $service->id) }}" method="POST"
                                class="inline-block">

                                @csrf
                                @method('PUT')

                                <button class="btn btn-lock px-3 py-1 rounded"
                                    onclick="return confirm('Hide this service?')">
                                    <i class="bi bi-eye-fill"></i>
                                </button>
                            </form>
                        @else
                            <form action="{{ route('admin.services.show', $service->id) }}" method="POST"
                                class="inline-block">
                                ...
                                <button class="btn btn-unlock px-3 py-1 rounded"
                                    onclick="return confirm('Show this service?')">
                                        ...
                                        @if ($service->thumbnail)
                                            <div class="service-main-card mb-4">
                                                ...
                                                <img src="{{ asset($service->thumbnail) }}"
                                                    alt="{{ $service->thumbnail_alt }}" class="service-preview-image">
                                        ...
                                        <div class="col-lg-8 d-flex">
                                            ...
                                            <div class="admin-card content-card flex-grow-1">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="overview" rows="5" class="form-control admin-input"
                                                        placeholder="Short service introduction..." required>{{ old('overview', $service->overview) }}</textarea>
                                            ...
                                            <div class="admin-card mb-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="category_id" class="form-select">
                                                        ...
                                                        <option value="{{ $service->category_id }}">
                                                            {{ $service->serviceCategory->name ?? '-- Select Category --' }}
                                                        </option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="is_visible" class="form-select">
                                                        ...
                                                        <option value="1"
                                                            {{ old('is_visible', $service->is_visible) == 1 ? 'selected' : '' }}>
                                                            Visible
                                                        </option>

                                                        <option value="0"
                                                            {{ old('is_visible', $service->is_visible) == 0 ? 'selected' : '' }}>
                                                            Hidden
                                                        </option>
                            ...
                            <div class="col-lg-8 d-flex">
                                ...
                                <div class="admin-card content-card flex-grow-1">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="overview" rows="5" class="form-control admin-input"
                                            placeholder="Short service introduction..." required>{{ old('overview') }}</textarea>
