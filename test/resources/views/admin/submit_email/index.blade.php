...
@section('content')
    <x-admin.page-header title="Submit Email Management" description="Manage all submit emails in the system">

        <x-slot:action>
            <button class="btn btn-create" data-bs-toggle="modal" data-bs-target="#createSubmitEmailModal">
                + Add Submitted Email
            </button>

            <a href="{{ route('admin.submit_emails.export') }}" class="btn btn-export">
                Export CSV
            </a>
        </x-slot:action>
            ...
            @foreach ($submitEmails as $submitEmail)
                <tr>
                    ...
                    @elseif ($submitEmail->status === 'processed')
                        <td>
                            <span
                                class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-semibold">Processed</span>
                        </td>
                    @else
                        <td>
                            <span
                                class="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-semibold">Pending</span>
                        </td>
                    @endif

                    <td>
                        <button class="btn btn-edit" data-bs-toggle="modal"
                            data-bs-target="#updateEmailModal{{ $submitEmail->id }}">
                ...
                <div class="modal fade" id="updateEmailModal{{ $submitEmail->id }}" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="admin-card">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="email" name="email"
                                                value="{{ old('email', $submitEmail->email) }}"
                                                class="form-control admin-input" placeholder="example@email.com" required>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="source"
                                                value="{{ old('source', $submitEmail->source) }}"
                                                class="form-control admin-input"
                                                placeholder="footer, popup, landing-page...">
                                        ...
                                        <div>
                                            ...
                                            <select name="status" class="form-select">
                                                ...
                                                <option value="pending"
                                                    {{ old('status', $submitEmail->status) == 'pending' ? 'selected' : '' }}>
                                                    Pending
                                                </option>

                                                <option value="processing"
                                                    {{ old('status', $submitEmail->status) == 'processing' ? 'selected' : '' }}>
                                                    Processing
                                                </option>

                                                <option value="processed"
                                                    {{ old('status', $submitEmail->status) == 'processed' ? 'selected' : '' }}>
                                                    Processed
                                                </option>
                        ...
                        <div class="admin-card">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="source" value="{{ old('source') }}"
                                    class="form-control admin-input" placeholder="footer, popup, landing-page...">
