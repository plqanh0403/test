    ...
    <section class="blog-page">
        ...
        <div class="container">
            ...
            <div class="blog-tabs-viewer">
                ...
                <a href="{{ route('viewer.blogs.index', ['type' => 'tech-service']) }}"
                    class="blog-tab-viewer {{ $type == 'tech-service' ? 'active' : '' }}">
                ...
                <a href="{{ route('viewer.blogs.index', ['type' => 'EGEAD-activity']) }}"
                    class="blog-tab-viewer {{ $type == 'EGEAD-activity' ? 'active' : '' }}">
                ...
                @if ($featuredSide->count() >= 3)
                    ...
                    <div class="featured-secondary-grid">
                        ...
                        <div class="featured-secondary-right">
                            @if ($verticalBlog)
                                @include('viewer.blog.partials.featured-vertical', [
                                    'blog' => $verticalBlog,
                                ])
                            @endif
                        </div>
